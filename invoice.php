...
//                  var product = document.getElementById("productlist"+divcount).value;
...
//                              }
//                          };
//                          xhttp.open("GET", "deleteinvoiceproduct.php?product=" + product+"&id="+id+"&src="+"prdct", true);
//                          xhttp.send();
//                }
        ...
        function remove() {
         ...
         function removeproduct(rowid) {
                  ...
                  var invid=document.getElementById("invid").value;
                          ...
                          xhttp.open("GET", "deleteinvoiceproduct.php?productname=" + productname+"&invid="+invid+"&src="+"prdct", true);
                          xhttp.send();
        }
...
//                alert(val);
            if (confirm("If you want to delete then press 'Ok'..!")) {
                ...
                xmlhttp.open("GET", "invoicedelete.php?val=" + val, true);
                xmlhttp.send();
            }
        }
...
<body>
    ...
    <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
                    <div class="mdl-layout__header-row">
                        <span class="mdl-layout-title">Invoice</span>
...
<div class="mdl-cell mdl-cell--5-col"></div>
    ...
    <div class="mdl-cell mdl-cell--6-col">
        ...
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label insearchbox">
            ...
            <label class="mdl-textfield__label" for="searchbox">Search by Invoice.No / Customer.Mob.No</label>

        </div>

       <button class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored asssignbtn" onclick='openopup(this.id,"newinvoice");getdate()' for="addbtn" id="addinvbtn">

           <div class="mdl-tooltip mdl-tooltip--large" for="addbtn">Create New Invoice</div>
           <i class="material-icons" style="align:center;outline:none;" id="addbtn">add</i>
                         ...
                         <center>
                            <h4 class="custnotfound">Oops... No Invoices Found!</h4>
                         </center>
<br>
<br>
<br>
                               ...
                               <td data-label="Sr No" class="mdl-data-table__cell--non-numeric ng-binding">{{$index + 1}}</td>
                                ...
                                <td data-label="Status" class="mdl-data-table__cell--non-numeric ng-binding assempnamescroll">{{x.InvoiceStatust}}</td>
                                 ...
                                 <td data-label="View/Edit" class="mdl-data-table__cell--non-numeric ng-binding">
                                           <button class="mdl-button mdl-js-button mdl-button--fab  mdl-button--colored asssignbtn" title="View/Edit" onclick='editdata(this.id,"updateinvoice");getdate()' id="{{x.InvoiceIdt}}" for="update">
...
-->
                                         <td data-label="Delete" class="mdl-data-table__cell--non-numeric ng-binding">
                                           <button class="mdl-button mdl-js-button mdl-button--fab  mdl-button--colored asssignbtn" title="Delete" onclick='deleteinvoice(this.id)' id="{{x.InvoiceIdt}}" for="deleteinv">
...
<dialog class="mdl-dialog" >
        ...
        <hr>
<form method="post" action="invoicedatainsertupdate.php" onsubmit="return valid()"  enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="mdl-grid">
                            ...
                            <div class="mdl-cell mdl-cell--4-col">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    ...
                                    ₹<input type="radio" id="rs"  name="discperrs" onclick="discountrs(this.value)" onchange="discountrs(this.value)"  onblur="discountrs(this.value)" value="Rs" checked>

                                    %<input type="radio" id="per"  name="discperrs"  onblur="discountrs(this.value)" onclick="discountrs(this.value)" onchange="discountrs(this.value)" value="Per" onselect="discountrs(this.value)">
...
//        }
        ...
        if(val1=="updateinvoice")
        {
            ...
            document.getElementById("invoicetxt").innerHTML = document.getElementById("invoicetxt").innerHTML.replace('Create New Invoice', 'Update Invoice');
            document.getElementById("invoicetxt").innerHTML = document.getElementById("invoicetxt").innerHTML.replace('View Invoice', 'Update Invoice');
...
//                    var pic=document.getElementById("tblPPhoto" + id).value;
    ...
    <script>
                ...
                x.controller("myctrl", function($scope, $http, $interval) {
                     ...
                     {                       
                        $http.post("invoicejson.php").then(function success(response)
                        {
