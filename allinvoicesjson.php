...
$query1=mysql_query("select *,GROUP_CONCAT(`EmpId`) AS EmployeeId from invoice_table_data where invoice_del_yes_no='YES' and CustId=$cid GROUP BY `InvoiceNo` order by InvoiceNo asc");
